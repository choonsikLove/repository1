...
<body>
	...
	<table class="product">
		<tr>
			<td>
				<div class="var">
					<a href="http://localhost:9000/manwol/admin/product_write"><button class="productButton">상품 수정</button></a>
				</div>
			</td>
		</tr>
					...
					<tr>
						<td colspan="2">
							<div class="Purchasing_review_list">
								...
								<p style=" color: #949494; cursor:pointer; font-size: 15px;"><small class="material-symbols-outlined" style="font-size: 18px;">image</small>  포토 구매평만 보기</p>
							</div>
						</td>
					</tr>

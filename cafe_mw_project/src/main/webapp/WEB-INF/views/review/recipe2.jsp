						...
						<td>
							<div>
								<ul class="category">
									...
									<li class="category_line"><a href="http://localhost:9000/manwol/recipe2"><span>말차</span></a></li>
									...
									<tr>
										<td>
											<div class="contents1">
												<a href="http://localhost:9000/manwol/product_group_order">
													<img alt="슈렉라떼"
													src="http://localhost:9000/manwol/resources/images/review/슈렉라떼1.jpg"
													height="400px" width="400px"></a>
												<p>
													<a href="#"> <strong>말차</strong> <span>슈렉라떼(말차에 밀크티 추가)</span></a>
												</p>
												<div class="wish_list">
													<a href="#"> 
										...
										<td>
											<div class="contents1">
												<a href="#">
													<img alt="스무디"
													src="http://localhost:9000/manwol/resources/images/review/스무디.jpg"
													height="400px" width="400px"></a>
												<p>
													<a href="#"><strong>말차</strong> <span>스무디</span></a>
												</p>
												<div class="wish_list">
													<a href="#"> 
														<span class="material-symbols-outlined" style="font-size: 18px; color: #004a98">favorite</span>

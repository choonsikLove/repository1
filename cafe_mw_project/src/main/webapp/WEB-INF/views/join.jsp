...
<style type="text/css">
	*{padding: 0; margin: 0;}
	...
	.join_title{text-align: center; margin-bottom: 10px;}
	.modal_exit{
		color: lightgray;
		font-size: 40px;
		position: absolute;
	...
	<div id='join_outer'>
		...
		<!-- 회원가입 최초 화면 -->
  		<div id='join_inner_1'>
			...
			<div id='mail_join'>다른 메일로 가입하기</div>
			<hr>
			<span>또는</span>
...
본 이용약관은 “(주)만월회”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.
...
① 운영자는 가입에 사용된 메일로 서비스와 관련된 신상품 소식, 이벤트 안내, 고객 혜택 등 다양한 정보를 제공할 수 있습니다.
...
서비스와 관련된 신상품 소식, 이벤트 안내, 고객 혜택 등 다양한 정보를 제공합니다.			
			...
			<span class='join_inner_2_btn' id='join_agree'>가입하기</span>
		</div>
 		...
 		<div id='join_inner_3'>
			...
			<form>
				<table class='join_table'>
					<tr><td><input type='text' name='email' class='input_box' placeholder='이메일'></td></tr>
					<tr><td><input type='password' name='pass' class='input_box' placeholder='비밀번호'></td></tr>
					<tr><td><input type='password' class='input_box' placeholder='비밀번호 확인'></td></tr>
				</table>
				<h4>이름&nbsp;<span class='join_circle'>&#x02022;</span></h4>
				<table class='join_table'>
					<tr><td><input type='text' name='name' class='input_box' placeholder='이름을(를) 입력하세요.'></td></tr>
				</table>
				<h4>연락처&nbsp;<span class='join_circle'>&#x02022;</span></h4>
				<table class='join_table'>
					<tr><td><input type='text' name='hp' class='input_box' placeholder='연락처'></td></tr>
				</table>
				<h4>주소</h4>
				<table class='join_table'>
					<tr><td><input type='text' name='addr1' class='input_box' placeholder='주소'></td></tr>
					<tr><td><input type='text' name='addr2' class='input_box' placeholder='상세주소'></td></tr>
				</table>
				<h4>추천인</h4>
				<table class='join_table'>
					<tr><td><input type='text' class='input_box' placeholder='추천인 코드를 입력하세요.'></td></tr>
				</table>
				<button id='join_submit' type='submit'>가입하기</button>
			</form>
		</div>
	</div>
</body>
